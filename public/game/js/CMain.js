function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'change_colour',loop:false,volume:1, ingamename: 'change_colour'});
        s_aSoundsInfo.push({path: './sounds/',filename:'destroy_row',loop:false,volume:1, ingamename: 'destroy_row'});
