<?php
    /*
    Plugin Name: CTL Arcade - Sliding Bricks
    Plugin URI: http://www.codethislab.com/
    Description: Sliding Bricks for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSlidingBricks{

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-sliding-bricks";
        private $_szPluginName              = "Sliding Bricks";
        private $_szAspectRatio             = "5:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bricks, ketchapp, skill game, tap game, arcade game, addicting game,trending app, survival game, matching game, colour match, color match, endless game, addictive, slide, sliding game";
    ...
    $g_oCTLArcadeSlidingBricks =  new CTLArcadeSlidingBricks();
